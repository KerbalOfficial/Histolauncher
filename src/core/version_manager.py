...
def _build_version_entry(
    *, base_dir: str, category: str, version: str, vpath: str
    ...
    return {
        ...
        "launch_min_ram": (meta.get("launch_min_ram") or "").strip(),
        "launch_max_ram": (meta.get("launch_max_ram") or "").strip(),
        "launch_extra_jvm_args": (meta.get("launch_extra_jvm_args") or "").strip(),
